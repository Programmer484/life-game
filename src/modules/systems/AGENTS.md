...
growth, XP, planting, unlocks — pure functions over world+entities
...
To change what this module may import, edit `allowedImports` for `systems` in
...
`allowedExternals` for `systems` in `module-map.json` (omit the key for
