...
trees, goals, tasks — typed data + factories
...
To change what this module may import, edit `allowedImports` for `entities` in
...
`allowedExternals` for `entities` in `module-map.json` (omit the key for
